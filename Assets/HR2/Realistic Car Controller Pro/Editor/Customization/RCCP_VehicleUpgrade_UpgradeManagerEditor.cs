...
public class RCCP_VehicleUpgrade_UpgradeManagerEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (NOS == null) {
            ...
            if (GUILayout.Button("Create NOS Upgrade"))
                CreateNOSUpgrade();
    ...
    private void CreateNOSUpgrade() {

        RCCP_VehicleUpgrade_NOS newGO = new GameObject("Upgrade_NOS").AddComponent<RCCP_VehicleUpgrade_NOS>();
        newGO.transform.SetParent(prop.transform);
        newGO.transform.localPosition = Vector3.zero;
        newGO.transform.localRotation = Quaternion.identity;
