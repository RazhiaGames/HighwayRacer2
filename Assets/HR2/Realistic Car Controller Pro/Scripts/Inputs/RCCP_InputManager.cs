    ...
    private RCCP_Inputs KeyboardInputs() {
        ...
        if (RCCPSettings.useNewInputSystem) {
            ...
            if (inputActionsInstance == null) {
                ...
                inputActionsInstance.actionMaps[0].actions[6].performed += HighBeamHeadlightsPerformed;
                inputActionsInstance.actionMaps[0].actions[6].canceled += HighBeamHeadlightsCanceled;
